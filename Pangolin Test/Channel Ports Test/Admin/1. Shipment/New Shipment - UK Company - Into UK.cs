...
{
    [TestClass]
    public class NewShipment_UKCompany_IntoUK : UITest
    {
        [PangolinTestMethod]
        public override void RunTest()
        {
            var shipment = new Constants.ShipmentFactory().CreateUKCompanyShipmentIntoUK();

            Run<NewCompanyUserForUKCompanyJimMilton, AddRouteBlackpoolAndCalais, AddProductForUKCompany_Keyboard,
                EditChannelPorts_AddPaymentInformation>();
