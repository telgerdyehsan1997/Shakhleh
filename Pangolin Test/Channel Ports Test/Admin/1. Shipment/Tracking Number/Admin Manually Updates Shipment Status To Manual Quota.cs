...
{
    [TestClass]
    public class AdminManuallyUpdatesShipmentStatusToManualQuota : UITest
    {
        [PangolinTestMethod]
        public override void RunTest()
        {
            ...
            Set("Progress").To("ManualQuota");
            ClickButton("Save");

            //Asserts that Progress has been updated
            AtRow(consignment.ConsignmentNumber).Column("Progress").Expect("Manual - Quota");
        }
    }
}