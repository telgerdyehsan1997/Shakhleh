...
{
    [TestClass]
    public class AddShipment_CFSP_SFDOnlyEnabled : UITest
    {
        [PangolinTestMethod]
        public override void RunTest()
        {
            var shipment = new Constants.ShipmentFactory().CreateCFSPShipment();

            Run<AdminAddsContactToCFSPCompany, AddRouteBlackpoolAndCalais, AddProductForCFSPOwnTestMonitor, EditCompany_CFSPOwn_EnableSFD>();
