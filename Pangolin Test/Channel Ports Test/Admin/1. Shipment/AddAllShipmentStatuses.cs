...
{
    [TestClass]
    public class AddAllShipmentStatuses : UITest
    {
        [PangolinTestMethod]
        public override void RunTest()
        {
            Run<AddAllShipmentStatuses_Pre_Condition>();

            LoginAs<ChannelPortsAdmin>();

            //after running this test case a sql query must be ran to update all statuses
            //this can be found in SQL folder in test project or below
