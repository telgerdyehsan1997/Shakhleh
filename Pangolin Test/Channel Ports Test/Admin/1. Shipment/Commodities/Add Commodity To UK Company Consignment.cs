...
{
    [TestClass]
    public class AddCommodityToUKCompanyConsignment : UITest
    {
        [PangolinTestMethod]
        public override void RunTest()
        {
            ...
            var commodity = new Constants.CommodityFactory().AddUKCompnayCommodityIntoUK();

            Run<AddConsignmentToUKCompany_IntoUK>();
