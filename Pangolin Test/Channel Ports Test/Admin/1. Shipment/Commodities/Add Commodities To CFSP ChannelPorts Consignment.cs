...
{
    [TestClass]
    public class AddCommoditiesToCFSPChannelPortsConsignment : UITest
    {
        [PangolinTestMethod]
        public override void RunTest()
        {
            ...
            var commodity = new Constants.CommodityFactory().AddCFSPChannelPortsCommodityIntoUK();

            Run<AddConsignmentChannelPortsCFSPShipment>();
