...
{
    [TestClass]
    public class AddCommodity_PaperLicence_IntoUK : UITest
    {
        [PangolinTestMethod]
        public override void RunTest()
        {
            ...
            Run<AddPaperLicence_IntoUK, AddConsignmentToMajimaConstruction_IntoUK>();
            ...
            this.ClickAndWait("Licence name", "Cultural");
            Set("Licence number").To("P2");
            Set("Quantity").To("5");
            Set("RPTID code").To("123456");
            ClickButton("Save");
