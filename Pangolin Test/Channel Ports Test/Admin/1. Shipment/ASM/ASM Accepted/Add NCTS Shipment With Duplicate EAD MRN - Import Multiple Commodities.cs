...
{
    [TestClass]
    public class AddNCTSShipmentWithDuplicateEADMRN_ImportMultipleCommodities : UITest
    {
        [PangolinTestMethod]
        public override void RunTest()
        {
            Run<AddNCTSShipmentWithMultipleCommodities>();
            ...
            //The follow workflow no longer exists
            //Checks that multiple Commodities are imported
            /*ExpectRow(firstCommodity);
            ExpectRow(secondCommodity);
            ExpectRow(thirdCommodity); */
        }
    }
}