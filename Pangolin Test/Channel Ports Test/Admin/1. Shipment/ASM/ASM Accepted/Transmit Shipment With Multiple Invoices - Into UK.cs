...
{
    [TestClass]
    public class TransmitShipmentWithMultipleInvoices_IntoUK : UITest
    {
        [PangolinTestMethod]
        public override void RunTest()
        {
            ...
            Run<AddCommoditiesToConsignmentWithMultipleInvoiceNumbers>();
            ...
            //Manually download and view ASM Request to see if all of the Invoice Numbers have been sent
        }
    }
}