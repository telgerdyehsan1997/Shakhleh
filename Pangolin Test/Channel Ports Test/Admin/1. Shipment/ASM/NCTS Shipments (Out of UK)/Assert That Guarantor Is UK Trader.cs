...
{
    [TestClass]
    public class AssertThatGuarantorIsUKTrader : UITest
    {
        [PangolinTestMethod]
        public override void RunTest()
        {
            var companyName = "MAJIMA CONSTRUCTION - SOTENBORI - OSA OB1 - 2134567";
            var ukTrader = "TRUCKERS LTD - WORCESTER - WR5 3DA - 68GB3470514001 - 7654321";
            var primaryContact = "KAZUMA KIRYU";
            var shipmentRoute = "Blackpool to CALAIS";
            var officeOfDestination = "PL SZCZECIN PL987654 POLAND";

            Run<CreateNewTransitOfficePL, AddRouteBlackpoolAndCalais, AdminAddsCompanyTruckersLtd, AddKazumaKiryuToMajimaConstruction, AddCompanyMajimaConstruction_DefNumberStartsWith2>();
            ...
            //Asserts that the UK Trader is the Guarantor since the Company has no Transit Guarantee 
