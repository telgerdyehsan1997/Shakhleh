...
{
    [TestClass]
    public class RoW_NewShipment : UITest
    {
        [PangolinTestMethod]
        public override void RunTest()
        {
            var shipment = new Constants.ShipmentFactory().CreateRoWShipmentIntoUK();

            Run<NewTaxLine_A00, AddKazumaKiryuToMajimaConstruction, AddRouteBlackpoolAndCalais, AddProductForMajimaConstruction_RoW, ImportRoWQuotas>();
