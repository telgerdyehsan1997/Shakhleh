...
{
    [TestClass]
    public class AddShipment_CFSP_ChannelPortsCFSP : UITest
    {
        [PangolinTestMethod]
        public override void RunTest()
        {
            var shipment = new Constants.ShipmentFactory().CreateChannelPortsCFSPShipment();

            Run<AdminAddsContactToCFSPCompany, AddRouteBlackpoolAndCalais, AddProductForCFSPOwnTestMonitor, EditCompany_CFSP_SetToChannelPorts, 
                SetCPCFSPMonthEndEmailAddress>();
