...
{
    [TestClass]
    public class AddConsignmentChannelPortsCFSPShipment : UITest
    {
        [PangolinTestMethod]
        public override void RunTest()
        {
            var trackingNumber = "R0721000001";
            var consignment = new Constants.ConsignmentFactory().AddChannelPortsCFSPConsignment();

            Run<AddShipment_CFSP_ChannelPortsCFSP>();
            ...
            //Adds the Consignment - As 'Using EIDR' is set to yes in Company Details, we set the full declaration details
