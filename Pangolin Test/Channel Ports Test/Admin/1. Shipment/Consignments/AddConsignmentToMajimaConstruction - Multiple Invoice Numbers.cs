...
{
    [TestClass]
    public class AddConsignmentToMajimaConstruction_MultipleInvoiceNumbers : UITest
    {
        [PangolinTestMethod]
        public override void RunTest()
        {
            ...
            //Adds multiple Invoice numbers
            Click("AddSecondInvoiceNumber");
            Set("Second invoice number").To("INTO-UK02");
            Click("AddThirdInvoiceNumber");
            Set("Third invoice number").To("INTO-UK03");
            Click("AddFourthInvoiceNumber");
            Set("Fourth invoice number").To("INTO-UK04");
