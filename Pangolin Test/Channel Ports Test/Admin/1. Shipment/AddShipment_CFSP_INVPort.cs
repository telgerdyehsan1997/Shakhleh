...
{
    [TestClass]
    public class AddShipment_CFSP_INVPort : UITest
    {
        [PangolinTestMethod]
        public override void RunTest()
        {
            var shipment = new Constants.ShipmentFactory().CreateCFSPShipmentINVPort();

            Run<AdminAddsContactToCFSPCompany, AddRoute_BarkingRailToCalais, AddProductForCFSPOwnTestMonitor>();
